...
function WeaponPickupInventoryAnarchy:Start()
	-- Base
    weaponPickupBase = self.targets.pickupBase.GetComponent(ScriptedBehaviour).self
...
function WeaponPickupInventoryAnarchy:PrimarySelected()
    weaponPickupBase:AnarchyDropWeaponSelected(0)
end

function WeaponPickupInventoryAnarchy:SecondarySelected()
    weaponPickupBase:AnarchyDropWeaponSelected(1)
end

function WeaponPickupInventoryAnarchy:Gear1Selected()
    weaponPickupBase:AnarchyDropWeaponSelected(2)
end

function WeaponPickupInventoryAnarchy:Gear2Selected()
    weaponPickupBase:AnarchyDropWeaponSelected(3)
end

function WeaponPickupInventoryAnarchy:Gear3Selected()
    weaponPickupBase:AnarchyDropWeaponSelected(4)
end